...
/* ----------------------------------------------
  ...
  for (i = 1; i < argc ; i++){
     ...
     * Option maxtime. Wall clock time by which to end simulation.
     * Same format as data wallclock output rate. E.g. "2.40h". */
 ...
 ********************************************************************* */
{
  ...
  printf (" -maxtime t\n");
  printf ("    Stop calculations after wallclock time t. \n");
  printf ("    Same format as data wallclock output rate in runtime file\n");
  printf ("    e.g., 2.40h.\n");
  /* -- AYW */
